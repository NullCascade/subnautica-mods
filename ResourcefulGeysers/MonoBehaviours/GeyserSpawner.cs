...
namespace ResourcefulGeysers.MonoBehaviours
{
    public class GeyserSpawner : MonoBehaviour
    {
        ...
        {
#if DEBUG
            Plugin.Log.LogDebug($"Setting spawner to use debug values.");
            Plugin.ChunkChance = 1.0f;
            Plugin.MinChunkCount = 10;
            Plugin.MaxChunkCount = 100;
            Plugin.MaxSpawnedObjects = 500;
#endif
        }
